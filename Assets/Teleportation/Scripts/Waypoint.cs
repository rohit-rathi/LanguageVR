...
public class Waypoint : MonoBehaviour
{
	...
	private GameObject TourGuide;
	private GameObject TourGuide1;
	...
	{		
		...
		TourGuide = GameObject.Find ("Tour Guide");
	}
	...
	public void Click()
	{
		...
		if(gameObject.name == "Waypoint (9)"){
			// play new task
			Vector3 position = new Vector3(-485.7f, 249.6f, 508.3f);
			TourGuide1 = Object.Instantiate(TourGuide, position, Quaternion.Euler(0f, -30f, 0f));
			//Destroy(TourGuide);
			Debug.Log("tour guide moves after 1st challange has been completed");
		}
		else if(gameObject.name == "Waypoint (28)"){
			//bring tour guide here
			// congratulate you for finishing
			Vector3 positionEnd = new Vector3(-88.2f, 249.6f, 648.4f);
			print ("before instantiation");
			GameObject TourGuide2 = Object.Instantiate(TourGuide, positionEnd, Quaternion.Euler(0f, -90f, 0f));
			print("after instantiation");
			Destroy(TourGuide);
			print ("destroyed first guy");
			Destroy(TourGuide1);
			print ("destroyed 2nd guy");
			Debug.Log("Congratulations on finishing");
		}
	}
